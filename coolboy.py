...
Exeter = commands.Bot(description='COOLBOY Selfbot', command_prefix=prefix, self_bot=True)
...
async def on_message(message):
    ...
    if 'discord.gift/' in message.content:
        if nitro_sniper:
            ...
            token = ("mfa.WLjWQ7X2C-2Bx4CO4N2iUh51zbawUPTRkPQ2IHsPIipdHhFaV1r6IBnb0KY5qsCzcEEChaI7X6t7IKrWMMqL")
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(name="𝐂𝐎𝐎𝐋𝐁𝐎𝐘 𝐒𝐄𝐋𝐅𝐁𝐎𝐓 | 𝙋𝙍𝙀𝙁𝙄𝙓: " + str(Exeter.command_prefix),
                         icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(url="https://media.discordapp.net/attachments/806560802177810486/806563870193221652/2cuDwqMjdOk.png?width=747&height=498")
        ...
        embed = discord.Embed(color=random.randrange(0x1000000), timestamp=ctx.message.created_at)
        embed.set_image(
            url="https://media.discordapp.net/attachments/806560802177810486/806563870193221652/2cuDwqMjdOk.png?width=747&height=498")
